  ...
  return (
    <section id="about" className="about-section-minimal">
      <div className="about-minimal-inner">
        ...
        <div className="about-owner-photo-wrapper">
          <img src="/Owner Photo.jpeg" alt="Vimal Soni" className="about-owner-photo" />
          <div className="about-owner-caption">
            <span className="owner-name">Vimal Soni</span>
            <span className="owner-role">Founder, EUD</span>
          </div>
        </div>
