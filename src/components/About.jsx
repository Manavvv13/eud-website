    ...
    <section id="about" className="about-section-minimal">
      <div className="about-minimal-inner">
        <p className="about-minimal-paragraph">
          ...
          <span className="about-inline-badge badge-1" style={{ backgroundImage: `url('/Testimonials/indian_family_1.jpg')` }} aria-hidden="true"></span>
          ...
          <span className="about-inline-badge badge-2" style={{ backgroundImage: `url('/Testimonials/indian_family_2.jpg')` }} aria-hidden="true"></span>
          <span className="text-highlight-gray">
